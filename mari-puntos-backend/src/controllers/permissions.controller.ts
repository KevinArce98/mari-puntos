...
export class PermissionsController {
  ...
  getPartnerPermissions = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
      ...
      logger.error(
        ...
        'Error getting partner permissions'
      );
      throw error;
    }
  };
  ...
  getPermissionById = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
      ...
      logger.error(
        { err: error, permissionId: req.params.id },
        'Error getting permission by ID'
      );
      throw error;
    }
  };
  ...
  respondToPermission = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
      ...
      logger.error(
        { err: error, userId: req.userId, permissionId: req.params.id },
        'Error responding to permission'
      );
      throw error;
    }
  };
