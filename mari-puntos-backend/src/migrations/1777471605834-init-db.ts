...
export class InitDb1777471605834 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."logs_type_enum" AS ENUM('points_earned', 'points_spent', 'level_up', 'achievement_unlocked', 'permission_requested', 'permission_approved', 'permission_rejected', 'action_created', 'action_approved', 'action_rejected', 'reward_redeemed', 'partner_linked', 'partner_unlinked', 'other')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."achievements_type_enum" AS ENUM('points_milestone', 'level_milestone', 'actions_completed', 'permissions_granted', 'streak', 'special')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "partner_links" ADD CONSTRAINT "FK_77ab731ca027e03259a7a4b76d5" FOREIGN KEY ("user1Id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "partner_links" ADD CONSTRAINT "FK_b052ab3c897027edc2d3fb51f56" FOREIGN KEY ("user2Id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "actions" ADD CONSTRAINT "FK_83a262823d7b54757fa07171b90" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "permissions" ADD CONSTRAINT "FK_e0a4d7230c57022b048b5f08501" FOREIGN KEY ("requesterId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "permissions" ADD CONSTRAINT "FK_aa1d66bd690f17dfd5f11b3bdb7" FOREIGN KEY ("approverId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "logs" ADD CONSTRAINT "FK_a1196a1956403417fe3a0343390" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "permissions" DROP CONSTRAINT "FK_aa1d66bd690f17dfd5f11b3bdb7"`
    );
    await queryRunner.query(
      `ALTER TABLE "permissions" DROP CONSTRAINT "FK_e0a4d7230c57022b048b5f08501"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "actions" DROP CONSTRAINT "FK_83a262823d7b54757fa07171b90"`
    );
    await queryRunner.query(
      `ALTER TABLE "partner_links" DROP CONSTRAINT "FK_b052ab3c897027edc2d3fb51f56"`
    );
    await queryRunner.query(
      `ALTER TABLE "partner_links" DROP CONSTRAINT "FK_77ab731ca027e03259a7a4b76d5"`
    );
