...
export class InitDb1769444959397 implements MigrationInterface {
    name = 'InitDb1769444959397'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "partner_links" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "linkCode" character varying NOT NULL, "status" "public"."partner_links_status_enum" NOT NULL DEFAULT 'pending', "user1Id" uuid, "user2Id" uuid, "linkedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_d650a3df76cd2f0f15a69b2afc0" UNIQUE ("linkCode"), CONSTRAINT "REL_77ab731ca027e03259a7a4b76d" UNIQUE ("user1Id"), CONSTRAINT "REL_b052ab3c897027edc2d3fb51f5" UNIQUE ("user2Id"), CONSTRAINT "PK_9b3ad64da16c31b2fe6377fda91" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "permissions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "requesterId" uuid NOT NULL, "approverId" uuid, "title" character varying NOT NULL, "description" text, "type" "public"."permissions_type_enum" NOT NULL DEFAULT 'other', "status" "public"."permissions_status_enum" NOT NULL DEFAULT 'pending', "requestedDate" TIMESTAMP NOT NULL, "durationHours" integer NOT NULL, "pointsCost" integer NOT NULL DEFAULT '0', "respondedAt" TIMESTAMP, "responseMessage" text, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "achievements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, "title" character varying NOT NULL, "description" text, "type" "public"."achievements_type_enum" NOT NULL, "iconUrl" text, "badgeUrl" text, "pointsReward" integer, "isUnlocked" boolean NOT NULL DEFAULT false, "unlockedAt" TIMESTAMP, "requiredValue" integer, "currentProgress" integer NOT NULL DEFAULT '0', "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1bc19c37c6249f70186f318d71d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "clerkId" character varying NOT NULL, "email" character varying NOT NULL, "firstName" character varying, "lastName" character varying, "avatarUrl" character varying, "totalPoints" integer NOT NULL DEFAULT '0', "currentLevel" integer NOT NULL DEFAULT '1', "pointsInCurrentLevel" integer NOT NULL DEFAULT '0', "partnerCode" character varying, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_b0e4d1eb939d0387788678c4f8e" UNIQUE ("clerkId"), CONSTRAINT "UQ_c0ea8a8737919839857ab84c3d9" UNIQUE ("partnerCode"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "rewards" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" text, "category" "public"."rewards_category_enum" NOT NULL DEFAULT 'other', "pointsCost" integer NOT NULL, "requiredLevel" integer, "imageUrl" text, "isActive" boolean NOT NULL DEFAULT true, "isCustom" boolean NOT NULL DEFAULT false, "createdBy" uuid, "partnerLinkId" uuid, "timesRedeemed" integer NOT NULL DEFAULT '0', "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3d947441a48debeb9b7366f8b8c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "levels" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "levelNumber" integer NOT NULL, "title" character varying NOT NULL, "description" text, "pointsRequired" integer NOT NULL, "iconUrl" text, "badgeUrl" text, "rewards" jsonb, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe433085876fbb63f110c78dfcf" UNIQUE ("levelNumber"), CONSTRAINT "PK_05f8dd8f715793c64d49e3f1901" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "permissions" ADD CONSTRAINT "FK_e0a4d7230c57022b048b5f08501" FOREIGN KEY ("requesterId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD CONSTRAINT "FK_aa1d66bd690f17dfd5f11b3bdb7" FOREIGN KEY ("approverId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "achievements" ADD CONSTRAINT "FK_a4c9761e826d07a1f4c51ca1d2b" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "rewards" ADD CONSTRAINT "FK_ac1a34bf83a4586e1e1e1dc554e" FOREIGN KEY ("partnerLinkId") REFERENCES "partner_links"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "rewards" DROP CONSTRAINT "FK_ac1a34bf83a4586e1e1e1dc554e"`);
