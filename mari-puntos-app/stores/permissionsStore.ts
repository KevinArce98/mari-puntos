...
export const usePermissionsStore = create<PermissionsState>((set, get) => ({
  ...
  fetchMyPermissions: async (params) => {
    set((s) => ({ isLoadingMyPermissions: true, isLoading: true || s.isLoadingPartnerPermissions, error: null }));
    try {
      const response = await permissionsService.getMyPermissions(params);
      set((s) => ({ myPermissions: response.data, isLoadingMyPermissions: false, isLoading: s.isLoadingPartnerPermissions || s.isMutating }));
      ...
      set((s) => ({ error: error.error || 'Failed to fetch permissions', isLoadingMyPermissions: false, isLoading: s.isLoadingPartnerPermissions || s.isMutating }));
      throw error;
    }
  },

  fetchPartnerPermissions: async (params) => {
    set((s) => ({ isLoadingPartnerPermissions: true, isLoading: s.isLoadingMyPermissions || true, error: null }));
    try {
      const response = await permissionsService.getPartnerPermissions(params);
      set((s) => ({ partnerPermissions: response.data, isLoadingPartnerPermissions: false, isLoading: s.isLoadingMyPermissions || s.isMutating }));
      ...
      set((s) => ({ error: error.error || 'Failed to fetch partner permissions', isLoadingPartnerPermissions: false, isLoading: s.isLoadingMyPermissions || s.isMutating }));
      throw error;
    }
  },
  ...
  createPermission: async (data) => {
    ...
    try {
      ...
      set((s) => ({ isMutating: false, isLoading: s.isLoadingMyPermissions || s.isLoadingPartnerPermissions }));
    } catch (error: any) {
      logger.error('Failed to create permission', error, { data });
      set((s) => ({ error: error.error || 'Failed to create permission', isMutating: false, isLoading: s.isLoadingMyPermissions || s.isLoadingPartnerPermissions }));
      throw error;
    }
  },
  ...
  updatePermission: async (permissionId, data) => {
    ...
    try {
      ...
      set((s) => ({ error: error.error || 'Failed to update permission', isMutating: false, isLoading: s.isLoadingMyPermissions || s.isLoadingPartnerPermissions }));
      throw error;
    }
  },
  ...
  respondToPermission: async (permissionId, approved, responseMessage, pointsCost) => {
    ...
    try {
      ...
      set((s) => ({ error: error.error || 'Failed to respond to permission', isMutating: false, isLoading: s.isLoadingMyPermissions || s.isLoadingPartnerPermissions }));
      throw error;
    }
  },
  ...
  cancelPermission: async (permissionId: string) => {
    ...
    try {
      ...
      set((s) => ({ error: error.error || 'Failed to cancel permission', isMutating: false, isLoading: s.isLoadingMyPermissions || s.isLoadingPartnerPermissions }));
      throw error;
    }
  },
